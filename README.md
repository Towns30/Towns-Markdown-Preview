...
3. 选择 `towns-markdown-preview-0.3.1.vsix`。
...
选择 `Notion`、`Paper`、`Dark`、`Sage` 或 `Cobalt`。已打开的 Markdown Preview 会立即请求刷新。
...
输出文件为 `towns-markdown-preview-0.3.1.vsix`。
